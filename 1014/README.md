...
模拟排队题，这种类型的题我没怎么做过，逻辑混乱纠结了好久。

题目大概意思：银行有 N 个窗口，每个窗口前最多允许排 M 个人，当每个窗口前都排满了 M 个人，其他人要在黄线后等待。每个人都会选择人少的队伍去排，如果多个队伍长度一样，选择编号小的。前 N 个人在 8:00 开始接受服务。现在有 K 个人，给出每个人接受服务的时间长度，求每个人接受完服务的时刻。

把排队逻辑梳理清楚直接用队列进行模拟。这种题不太熟，要多练练。
